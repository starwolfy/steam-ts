...
async.series([
    ...
    function(callback) {
        ...
        if (typeof verified.users[0] === "undefined") {
            callback(null);
            return;
        }
...
function(err, results) {
    ...
    function (err, results) {
        ...
        queryUsers(teamspeakClient, config.queryinterval, teamspeakStatus);
        ...
        if (config.webserverEnabled) {
            ...
            launchwww(config.webserverPort, config.sessionSecret, configjson.main.useHttps);
