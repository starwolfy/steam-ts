//TO DO:
//- Deal with situations where TeamSpeak servers might go offline. (Attempt to reconnect every x seconds.)
...
exports.launch = function() {
    ...
    function(err, results) {
        ...
        function (err, results) {
            ...
            listenChat(config, steamClient, teamspeakClient, verified_users);
