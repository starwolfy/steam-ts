            ...
            teamspeakClient.send("clientfind", {pattern: nickname}, function (err, response) {
                if (typeof err !== "undefined") {
                    ...
                    if (response.constructor == Array) {
                        ...
                        steamClient.chatMessage(senderID, "Too many users with the same name, please temporarily adjust your name and restart this verification process using !verify.");
                        delete currentlyVerifying[senderID.accountid];
